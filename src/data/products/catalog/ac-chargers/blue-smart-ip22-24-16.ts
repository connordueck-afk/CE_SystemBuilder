...
const product: Product = {
  ...
  terminals: [
    ...
    { id: "dc_pos", terminalGroupId: "dc_pos", label: "DC+", side: "bottom", offsetX: 8, offsetY: 68, maxCurrentA: 16, connector: { kind: "screw_terminal" }, notes: "DC output positive." },
    { id: "dc_neg", terminalGroupId: "dc_neg", label: "DC-", side: "bottom", offsetX: 24, offsetY: 68, maxCurrentA: 16, connector: { kind: "screw_terminal" }, notes: "DC output negative." }
  ],
  ports: [
