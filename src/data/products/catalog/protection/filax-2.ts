...
const product: Product = {
  ...
  imageUrl: '/product-images/victron/filax_2.svg',
  category: 'Protection',
  msrpUsd: 316,
  ...
  terminals: [
    { id: 'ac_in_1_l', terminalGroupId: 'ac_in_1_l', label: 'In1 L', side: 'left', offsetX: -63, offsetY: -27, connector: { kind: 'screw_terminal' } },
    { id: 'ac_in_1_n', terminalGroupId: 'ac_in_1_n', label: 'In1 N', side: 'left', offsetX: -63, offsetY: -9, connector: { kind: 'screw_terminal' } },
    { id: 'ac_in_2_l', terminalGroupId: 'ac_in_2_l', label: 'In2 L', side: 'left', offsetX: -63, offsetY: 9, connector: { kind: 'screw_terminal' } },
    { id: 'ac_in_2_n', terminalGroupId: 'ac_in_2_n', label: 'In2 N', side: 'left', offsetX: -63, offsetY: 27, connector: { kind: 'screw_terminal' } },
    { id: 'ac_out_l', terminalGroupId: 'ac_out_l', label: 'Out L', side: 'right', offsetX: 63, offsetY: -9, connector: { kind: 'screw_terminal' } },
    { id: 'ac_out_n', terminalGroupId: 'ac_out_n', label: 'Out N', side: 'right', offsetX: 63, offsetY: 9, connector: { kind: 'screw_terminal' } },
  ],
  ports: [
