...
const product: Product = {
  ...
  terminalGroups: [
    {
      ...
      notes: "Line side of the fuse element (distinct node from the load side)."
    },
    {
      id: "out",
      portId: "main",
      ...
      polarity: "positive",
      internallyCommon: false,
      notes: "Load side of the fuse element (distinct node from the line side)."
    }
  ],
  protectionRatings: {
    currentRatingA: 0,
  ...
  variants: [
    ...
    {
      id: "fuse-class-t-400a",
      currentRatingA: 400,
      msrpUsd: 60,
      oemPriceUsd: 42
    },
    {
      id: "fuse-class-t-450a",
      currentRatingA: 450,
      msrpUsd: 63,
      oemPriceUsd: 44
    },
    {
      id: "fuse-class-t-500a",
      currentRatingA: 500,
      msrpUsd: 66,
      oemPriceUsd: 46
    },
    {
      id: "fuse-class-t-600a",
      currentRatingA: 600,
      msrpUsd: 71,
      oemPriceUsd: 50
    }
