...
const product: Product = {
  ...
  "terminalGroups": [
    ...
    },
    {
      "id": "can_bus_iface",
      "portId": "can_bus",
      "label": "BMS-Can / VE.Can Interface",
  ...
  "terminals": [
    {
      ...
      "notes": "Low-voltage system signal/control interface."
    },
    {
      "id": "can_bus",
      "terminalGroupId": "can_bus_iface",
    ...
    {
      "id": "ethernet",
      "terminalGroupId": "ethernet_iface",
      "label": "Ethernet",
      "side": "top",
      "offsetX": 40,
      "offsetY": -30,
