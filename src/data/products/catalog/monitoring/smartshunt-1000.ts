...
const product: Product = {
  ...
  terminals: [
    { id: "shunt_pos", terminalGroupId: "shunt_batt_side", label: "BATT-", side: "top", offsetX: -31, offsetY: -23, maxCurrentA: 1000, connector: { kind: "stud", holeSize: "M10" }, notes: "Battery negative side of the 1000A shunt." },
    { id: "shunt_neg", terminalGroupId: "shunt_bus_side", label: "SYS-", side: "top", offsetX: 31, offsetY: -23, maxCurrentA: 1000, connector: { kind: "stud", holeSize: "M10" }, notes: "System/load negative side of the 1000A shunt." },
