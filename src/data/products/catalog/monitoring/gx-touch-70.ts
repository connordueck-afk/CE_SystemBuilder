...
const product: Product = {
  ...
  "category": "Monitoring",
  "msrpUsd": 397,
  "description": "Victron GX Touch 70 7-inch touchscreen display for Cerbo GX using HDMI/USB connection.",
  ...
  "terminals": [
    {
      ...
      "notes": "HDMI/USB display connection to a GX device."
    }
  ],
  "ports": [
    {
