...
const product: Product = {
  ...
  productType: "monitor",
  imageUrl: '/product-images/victron/bmv_712_smart.svg',
  category: "Monitoring",
  msrpUsd: 149,
  oemPriceUsd: 104,
  ...
  terminals: [
    { id: "shunt_pos", terminalGroupId: "sense_pos", label: "Shunt+", side: "bottom", offsetX: -18, offsetY: 38, maxCurrentA: 1, connector: { kind: "screw_terminal" }, notes: "Positive sense connection via 500A/50mV shunt (included)." },
    { id: "shunt_neg", terminalGroupId: "sense_neg", label: "Shunt-", side: "bottom", offsetX: 18, offsetY: 38, maxCurrentA: 1, connector: { kind: "screw_terminal" }, notes: "Negative sense connection (load side of shunt)." }
  ],
  ports: [
