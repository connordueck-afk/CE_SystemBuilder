...
const product: Product = {
  "id": "solar-branch-3-1-neg",
  "manufacturer": "Generic",
  "name": "3-1 PV Branch Connector (Negative)",
  "productType": "solar_combiner",
  "category": "Connectors",
  "imageUrl": "/product-images/pv-branch-3-1-neg.svg",
  "maxPvVoltageV": 1000,
  "maxPvCurrentA": 45,
  "msrpUsd": 36,
  "oemPriceUsd": 25,
  "description": "3-to-1 PV branch connector, multi-female to single-male. Combines 3 same-polarity solar conductors. Wired for either PV+ or PV- depending on where it's placed in the string.",
  "source": "Estimate",
