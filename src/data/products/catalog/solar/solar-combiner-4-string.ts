...
const stringCount = 4;
const stringOffsets = [-30, -10, 10, 30];

const terminalGroups: TerminalGroupDefinition[] = [
  { id: "positive_bus", portId: "positive_bus", label: "Positive Bus", groupType: "power_conductor", polarity: "positive", internallyCommon: true, maxCurrentA: 60, maxVoltageV: 150 },
  { id: "negative_bus", portId: "negative_bus", label: "Negative Bus", groupType: "power_conductor", polarity: "negative", internallyCommon: true, maxCurrentA: 60, maxVoltageV: 150 }
];
...
const product: Product = {
  ...
  ports: [
    { id: "positive_bus", kind: "pv", topology: "bus", label: "PV Positive Bus", voltageClass: "pv_high_voltage", voltageMaxV: 150, maxCurrentA: 60, role: "bus", direction: "bidirectional" },
    { id: "negative_bus", kind: "pv", topology: "bus", label: "PV Negative Bus", voltageClass: "pv_high_voltage", voltageMaxV: 150, maxCurrentA: 60, role: "bus", direction: "bidirectional" }
  ]
};
