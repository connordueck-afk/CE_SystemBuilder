...
const product: Product = {
  "id": "solar-branch-2-1-pos",
  "manufacturer": "Generic",
  "name": "2-1 PV Branch Connector (Positive)",
  "productType": "solar_combiner",
  "category": "Connectors",
  "imageUrl": "/product-images/pv-branch-2-1-pos.svg",
  "maxPvVoltageV": 1000,
  "maxPvCurrentA": 30,
  "msrpUsd": 30,
  "oemPriceUsd": 21,
  "description": "2-to-1 PV branch connector, multi-male to single-female. Combines 2 same-polarity solar conductors. Wired for either PV+ or PV- depending on where it's placed in the string.",
  "source": "Estimate",
