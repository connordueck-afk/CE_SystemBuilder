...
const product: Product = {
  "id": "solar-branch-4-1-neg",
  "manufacturer": "Generic",
  "name": "4-1 PV Branch Connector (Negative)",
  "productType": "solar_combiner",
  "category": "Connectors",
  "imageUrl": "/product-images/pv-branch-4-1-neg.svg",
  "maxPvVoltageV": 1000,
  "maxPvCurrentA": 60,
  "msrpUsd": 42,
  "oemPriceUsd": 29,
  "description": "4-to-1 PV branch connector, multi-female to single-male. Combines 4 same-polarity solar conductors. Wired for either PV+ or PV- depending on where it's placed in the string.",
  "source": "Estimate",
