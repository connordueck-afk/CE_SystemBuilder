...
const product = defineDistributionProduct({
  ...
  height: 106,
  terminals: [
    dcStudTerminal({ id: 'main_pos', label: 'Bat+', terminalGroupId: 'positive_bus', side: 'left', offsetX: -82, offsetY: -28, busLinkStandard: 'victron-lynx', notes: 'Main positive input (battery side). Bidirectional.' }),
    dcStudTerminal({ id: 'main_neg', label: 'Bat-', terminalGroupId: 'negative_bus', side: 'left', offsetX: -82, offsetY: 28, busLinkStandard: 'victron-lynx', notes: 'Main negative input (battery side). Bidirectional.' }),
    dcStudTerminal({ id: 'pass_pos', label: 'Bus+', terminalGroupId: 'positive_bus', side: 'right', offsetX: 82, offsetY: -28, busLinkStandard: 'victron-lynx', notes: 'Unfused positive pass-through to the next Lynx module. Bidirectional.' }),
    dcStudTerminal({ id: 'pass_neg', label: 'Bus-', terminalGroupId: 'negative_bus', side: 'right', offsetX: 82, offsetY: 28, busLinkStandard: 'victron-lynx', notes: 'Unfused negative pass-through to the next Lynx module. Bidirectional.' }),
