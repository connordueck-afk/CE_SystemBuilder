...
const product = defineDistributionProduct({
  ...
  height: 106,
  terminals: [
    dcStudTerminal({ id: 'bat_pos', label: 'Bat+', terminalGroupId: 'bat_pos', side: 'left', offsetX: -65, offsetY: -25, busLinkStandard: 'victron-lynx' }),
    dcStudTerminal({ id: 'bat_neg', label: 'Bat-', terminalGroupId: 'bat_neg', side: 'left', offsetX: -65, offsetY: 25, busLinkStandard: 'victron-lynx' }),
    dcStudTerminal({ id: 'load_pos', label: 'Load+', terminalGroupId: 'load_pos', side: 'right', offsetX: 65, offsetY: -25, busLinkStandard: 'victron-lynx' }),
    dcStudTerminal({ id: 'load_neg', label: 'Load-', terminalGroupId: 'load_neg', side: 'right', offsetX: 65, offsetY: 25, busLinkStandard: 'victron-lynx' }),
    commTerminal({ id: 've_can', label: 'VE.Can', terminalGroupId: 've_can_iface', side: 'top', offsetX: 0, offsetY: -52 }),
  ],
  terminalGroups: [
