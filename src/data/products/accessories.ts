...
export const accessories: Product[] = [
  ...
  // ----------------------------------------------------------
  {
    ...
    productUrl: 'https://www.victronenergy.com/panel-systems-remote-monitoring/cerbo-gx',
    source: 'Victron 2024',
    dataQuality: 'complete',
    width: 80,
    height: 60,
  ...
  },
  {
    ...
    height: 64,
    terminals: [
      { id: 'in_pos', label: 'In+', electricalType: 'pv_pos', kind: 'pv_power', polarity: 'positive', role: 'pass_through', voltageClass: 'pv_high_voltage', side: 'left', offsetX: -40, offsetY: -10, domain: 'pv' },
      { id: 'out_pos', label: 'Out+', electricalType: 'pv_pos', kind: 'pv_power', polarity: 'positive', role: 'pass_through', voltageClass: 'pv_high_voltage', side: 'right', offsetX: 40, offsetY: -10, domain: 'pv' },
      { id: 'in_neg', label: 'In-', electricalType: 'pv_neg', kind: 'pv_power', polarity: 'negative', role: 'pass_through', voltageClass: 'pv_high_voltage', side: 'left', offsetX: -40, offsetY: 10, domain: 'pv' },
      { id: 'out_neg', label: 'Out-', electricalType: 'pv_neg', kind: 'pv_power', polarity: 'negative', role: 'pass_through', voltageClass: 'pv_high_voltage', side: 'right', offsetX: 40, offsetY: 10, domain: 'pv' },
    ],
  },
  ...
  // ----------------------------------------------------------
  {
    ...
    productUrl: 'https://www.victronenergy.com/dc-dc-converters/orion-tr-smart',
    source: 'Victron 2024',
    dataQuality: 'partial',
    width: 80,
    height: 60,
