...
export function MpptSymbol({ product, selected }: Props) {
  ...
  return (
    <g>
      ...
      />
      <text x={0} y={-8} textAnchor="middle" fill="#c98518" fontSize={11} fontWeight="bold">MPPT</text>
      <text x={0} y={6} textAnchor="middle" fill="#46546a" fontSize={8} fontWeight={800}>
        {product.maxPvVoltageV}V / {product.maxCurrentA}A
      </text>
      {/* PV arrow left */}
      <text x={-hw + 6} y={-12} fill="#c98518" fontSize={8} fontWeight={800}>PV</text>
      {/* BAT arrow right */}
      <text x={hw - 18} y={-12} fill="#2f9461" fontSize={8} fontWeight={800}>BAT</text>
      {/* Arrow symbol */}
