...
export function FuseSymbol({ product, component, selected }: Props) {
  ...
  const ratingText = product.maxCurrentA ? `${product.maxCurrentA}A` : '';
  ...
  return (
    <g>
      ...
      {/* Rating above */}
      <text x={0} y={-hh - 4} textAnchor="middle" fill={color} fontSize={8}>
        {ratingText}
      </text>
      {/* Label below (only if auto-generated label) */}
      {component.autoGenerated && (
        <text x={0} y={hh + 10} textAnchor="middle" fill="#6d7b90" fontSize={7} fontWeight={800}>
